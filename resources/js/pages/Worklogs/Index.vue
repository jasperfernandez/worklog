                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center space-x-8">
                        ...
                        <nav class="hidden md:flex space-x-8">
                            ...
                            <Link href="/worklogs" class="text-indigo-600 font-medium dark:text-indigo-400">
                                Work Logs
                            </Link>
                        </nav>
                    </div>
        ...
        <main class="py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            Track your daily work activities and achievements
                        </p>
                    </div>
                ...
                <div class="bg-white shadow-sm rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <div v-if="worklogs.data.length === 0" class="text-center py-12">
                    ...
                    <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
                        <div
                            v-for="worklog in worklogs.data"
                            :key="worklog.id"
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center space-x-2 mb-2">
                                        ...
                                        <span v-if="worklog.files.length > 0" class="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                    ...
                    <!-- Pagination -->
                    <div v-if="worklogs.last_page > 1" class="bg-gray-50 px-6 py-3 border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700 dark:text-gray-300">
                                Showing {{ ((worklogs.current_page - 1) * worklogs.per_page) + 1 }} to
                                {{ Math.min(worklogs.current_page * worklogs.per_page, worklogs.total) }} of
                                {{ worklogs.total }} results
                            </div>
                            <div class="flex space-x-1">
                                <Link
                                    ...
                                    :class="{
                                        ...
                                        'bg-gray-200 text-gray-400 cursor-not-allowed dark:bg-gray-600 dark:text-gray-500': !link.url
                                    }"
                                    class="px-3 py-2 text-sm font-medium rounded-md border border-gray-300 dark:border-gray-600"
                                >
